...
def index():
    ...
    try:
        ...
        return render_template(
            "user_page/treatment_history_page/index.html",
    ...
    try:
        ...
        if form.validate_on_submit():
            ...
            if history is None:
                ...
                return render_template(
                    "user_page/treatment_history_page/create.html",
...
def detail(id):
    ...
    try:
        ...
        return render_template(
            "user_page/treatment_history_page/detail.html",
...
def edit(id):
    ...
    try:
        ...
        return render_template(
            "user_page/treatment_history_page/edit.html",
...
def delete(id):
    ...
    try:
        ...
        return render_template(
            "user_page/treatment_history_page/delete.html",
            history=history,
            user=current_user
        )
